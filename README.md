...
|  | Типичные сценарии использования | Рекомендации по использованию | Важные моменты при внедрении | Column 7 | Column 8 |
| --- | --- | --- | --- | --- | --- |
...
*   Временное хранение конфигураций | *   Простые ключи и значения
    
*   Основной упор на скорость
    
*   Минимальное количество операций | *   Планирование размера кеша
...
*   Балансировка нагрузки | Cell 1-7 | Cell 1-8 |
...
*   Публикация/подписка | *   Сложные структуры данных
    
*   Дополнительные возможности (публикации, очереди)
    
*   Персистентность данных | 1.  Очереди сообщений
...
5.  Публикация/подписка | Cell 2-7 | Cell 2-8 |

### **2\. Типичные проблемы, которые решаются рассмотренными технологиями кэширования:**
...
### **3\. Примеры реальных проблем, решаемых в продакшен сервисах:**
...
### **13\. Важные моменты при внедрении:**

*   Планирование размера кеша
